 ...
 */
public class BookShelfGrilFragment extends BaseMVPFragment<BillBookContract.Presenter> implements BillBookContract.View {
    ...
    private ArrayList<BookListBean1.FemaleBean> books = new ArrayList<>();
    private String id;
    ...
    public void finishLoading(BookListBean1 beans) {
        if (beans != null && beans.getFemale() != null) {
            books.addAll(beans.getFemale());
