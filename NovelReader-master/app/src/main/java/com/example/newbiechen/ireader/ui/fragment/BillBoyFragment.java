 ...
 */
public class BillBoyFragment extends BaseMVPFragment<BillBookContract.Presenter> implements BillBookContract.View {
    ...
    Unbinder unbinder;
    private List<BookListBean1.MaleBean> list = new ArrayList<>();
    ...
    public void finishLoading(BookListBean1 beans) {
        if (beans != null) {
            ...
            for (int i = 0; i < beans.getMale().size(); i++) {
            ...
            tabVertical.setTabAdapter(new TabAdapter() {
                ...
                public ITabView.TabTitle getTitle(int position) {
                    ITabView.TabTitle title = new ITabView.TabTitle.Builder()
                            ...
                            .setTextColor(R.color.mytab, Color.BLACK)
                            .build();
                    return title;
                }
    ...
    protected int getContentId() {
        return R.layout.fragment_bill_boy;
    }
