...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_MIN_WIDTH_MARGIN = 58;
    @Dimension(
        unit = 0
    )
    ...
    public Tab getTabAt(int index) {
        return index >= 0 && index < this.getTabCount()?(Tab)this.tabs.get(index):null;
    }
        ...
        private void updateIndicatorPosition() {
            ...
            if(selectedTitle != null && selectedTitle.getWidth() > 0) {
                ...
                if(!TabLayout.this.tabIndicatorFullWidth && selectedTitle instanceof TabView) {
                    this.calculateTabViewContentBounds((TabView)selectedTitle, TabLayout.this.tabViewContentBounds);
                ...
                if(this.selectionOffset > 0.0F && this.selectedPosition < this.getChildCount() - 1) {
                    ...
                    if(!TabLayout.this.tabIndicatorFullWidth && nextTitle instanceof TabView) {
                        this.calculateTabViewContentBounds((TabView)nextTitle, TabLayout.this.tabViewContentBounds);
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if(targetView == null) {
                ...
                if(!TabLayout.this.tabIndicatorFullWidth && targetView instanceof TabView) {
                    this.calculateTabViewContentBounds((TabView)targetView, TabLayout.this.tabViewContentBounds);
